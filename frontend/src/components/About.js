...
const About = () => {
  ...
  return (
    <motion.section id="about"
      className="py-20 sm:py-32 px-2 sm:px-6 bg-white/30 dark:bg-gray-900/30 backdrop-blur-md text-black dark:text-white transition-colors duration-300"
    ...
    >
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-5xl font-bold mb-6 sm:mb-8">About Me</h2>
        ...
        >
          <div className="bg-gray-100 h-56 sm:h-96 rounded-lg shadow-lg flex items-center justify-center overflow-hidden">
      ...
      <div className="flex justify-center mt-10 sm:mt-12 relative z-10">
        <motion.button
          className="px-6 py-2 sm:px-8 sm:py-3 bg-purple-600 text-white font-semibold rounded-lg shadow-lg hover:bg-purple-700 transition-all text-base sm:text-lg"
      ...
      <AnimatePresence>
        {showResume && (
          ...
          >
            <motion.div
              className="bg-white rounded-lg shadow-2xl p-2 sm:p-4 w-[98vw] max-w-lg sm:max-w-3xl max-h-[90vh] flex flex-col relative"
              initial={{ scale: 0.8, opacity: 0 }}
