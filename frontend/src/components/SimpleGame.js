...
const diceGradients = [
    "", // unused
    "from-yellow-400 via-yellow-200 to-yellow-500",
    "from-purple-400 via-purple-200 to-purple-500",
    "from-blue-400 via-blue-200 to-blue-500",
    "from-pink-400 via-pink-200 to-pink-500",
    "from-green-400 via-green-200 to-green-500",
    "from-red-400 via-red-200 to-red-500",
];
...
const SimpleGame = () => {
    ...
    const totalScore = scores.reduce((a, b) => a + (b || 0), 0) + streakBonus;
    ...
    function getSuggestedHolds() {
        ...
        if (
            cat.name === "Yahtzee" ||
            cat.name === "Three of a Kind" ||
            cat.name === "Four of a Kind" ||
            cat.name === "Full House"
        ) {
    ...
    return (
        <div className="flex flex-col items-center w-full h-full px-2 sm:px-0">
            <div className="flex items-center justify-between w-full mb-2">
                <h3 className="text-2xl font-bold mb-2 text-purple-700 dark:text-purple-300 flex-1 text-center">
                    🎲 Yahtzee Mini
                </h3>
                <button
            ...
            <div className="flex gap-2 sm:gap-3 mb-4 flex-wrap justify-center">
              ...
              bg-gradient-to-br ${diceGradients[d]}
            `}
                        style={{
            ...
            {showHelp && (
                <div className="w-full max-w-xs mb-4 bg-white/90 dark:bg-gray-800/90 rounded-lg shadow p-3 text-xs text-gray-700 dark:text-gray-200">
                    ...
                    <div className="mt-2 text-[11px] text-gray-500">
                        Hold dice by tapping them. You get up to 3 rolls per turn. After rolling, select a category to score. Each
                        category can be used only once.
                        <br />
                        <span className="text-green-700">Green-highlighted dice</span> are suggested holds for the best scoring
                        option.
                    </div>
                </div>
            )}
            <div
                className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-white/80 dark:bg-gray-800/80 rounded-xl shadow p-2 mb-2 overflow-x-auto"
                style={{
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row justify-between text-xs mt-2 gap-2">
                    <span>
                        ...
                        {streakBonus > 0 && (
                            <span className="ml-2 text-yellow-700 font-bold">+{streakBonus} Streak</span>
                        )}
                    </span>
                </div>
            </div>
            {gameOver && (
                <div className="mt-4 text-center">
                    ...
                    <div className="mb-2">
                        Final Score: <span className="font-bold">{totalScore}</span>
                    </div>
                    <button
